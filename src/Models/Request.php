...
class Request extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('codicastudio.statistics.tables.requests'));
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.route'), 'route_id', 'id', 'route');
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.path'), 'path_id', 'id', 'path');
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.agent'), 'agent_id', 'id', 'agent');
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.geoip'), 'geoip_id', 'id', 'geoip');
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.device'), 'device_id', 'id', 'device');
    }
    ...
    {
        return $this->belongsTo(config('codicastudio.statistics.models.platform'), 'platform_id', 'id', 'platform');
    }
