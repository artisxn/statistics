...
namespace codicastudio\Statistics\Http\Middleware;

use Closure;
use Carbon\Carbon;
use Illuminate\Http\Request;
use codicastudio\Statistics\Jobs\CrunchStatistics;
use codicastudio\Statistics\Jobs\CleanStatisticsRequests;
...
class TrackStatistics
{
    ...
    public function terminate($request, $response): void
    {
        ...
        app('codicastudio.statistics.datum')->fill([
    ...
    {
        $config = config('codicastudio.statistics.lottery');
